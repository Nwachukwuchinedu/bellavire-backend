 ...
 *                   example: false
 */
router.get('/me', authenticateAdminToken, AdminAuthController.getCurrentAdmin);
 ...
 *                   example: false
 */
router.post('/change-password', authenticateAdminToken, AdminAuthController.changePassword);
